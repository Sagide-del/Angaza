...
// True only when a real WhatsApp Business API provider is wired up. Without
// this, sendWhatsApp/sendDocument silently fall back to console.log — which
// on Vercel means nothing actually reaches the customer's phone.
const isConfigured = () => Boolean(
  (WHATSAPP_PROVIDER === 'meta' && META_PHONE_ID && META_TOKEN) ||
  (WHATSAPP_PROVIDER === 'twilio' && TWILIO_SID && TWILIO_AUTH && TWILIO_FROM)
);
...
module.exports = { sendWhatsApp, sendDocument, to254, isConfigured };
